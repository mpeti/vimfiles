...
if &background == "dark"
    if s:moria_style == "dark"
        ...
        hi CursorColumn ctermbg=DarkGray ctermfg=White guibg=#323232 gui=none
        hi CursorLine ctermbg=DarkGray ctermfg=White guibg=#323232 gui=none
    ...
    if s:moria_monochrome == 1
        ...
        hi LineNr guifg=#a0a0a0 guibg=#373737 gui=none
        ...
        hi LineNr guifg=#8fa5d1 guibg=#373737 gui=none
